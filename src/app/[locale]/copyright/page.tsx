...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Himeko Nova Wiki',
    description: 'Copyright and intellectual property information for Himeko Nova Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Himeko Nova Wiki',
      description: 'Copyright and intellectual property information for Himeko Nova Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Himeko Nova Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Himeko Nova Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Himeko Nova Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Honkai Impact 3rd Developers</strong> - Creators of the Honkai Impact 3rd game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>STEAM</strong> - Trademark of HoYoverse</li>
              <li><strong>Honkai Impact 3rd</strong> - Trademark of the game developers</li>
              <li><strong>Himeko Nova Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Himeko Nova Wiki.
            </p>
            ...
            <p>
              ...
              Himeko Nova Wiki<br />
              Email: <a href="mailto:dmca@himekonova.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@himekonova.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Himeko Nova Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Himeko Nova Wiki (himekonova.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@himekonova.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@himekonova.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@himekonova.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@himekonova.wiki</a>
            </p>
            <p>
