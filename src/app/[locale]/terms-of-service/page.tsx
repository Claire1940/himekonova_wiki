...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Himeko Nova Wiki",
    description: "Read the Terms of Service for Himeko Nova Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Himeko Nova Wiki",
      description: "Terms and conditions for using Himeko Nova Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Himeko Nova Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Himeko Nova Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Himeko Nova Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Himeko Nova Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Honkai Impact 3rd". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Battlesuit build guides and team compositions</li>
              <li>Skill breakdowns and rotation guides</li>
              <li>Weapon and stigmata recommendations</li>
              <li>Lore and character story guides</li>
              <li>Patch notes and game update coverage</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Himeko Nova Wiki is NOT affiliated with, endorsed by, or associated with
              HoYoverse (miHoYo) or the official developers of Honkai Impact 3rd. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Himeko Nova Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of HoYoverse (miHoYo) and/or HoYoverse, the developers of Honkai Impact 3rd. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, HIMEKO NOVA WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Himeko Nova Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@himekonova.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@himekonova.wiki</a>
            </p>
            <p>
